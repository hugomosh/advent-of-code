...
</ul><p>So, the last completion string above - <code>])}&gt;</code> - would be scored as follows:</p><ul>
...
</ul><p>The five lines' completion strings have total scores as follows:</p><ul>
